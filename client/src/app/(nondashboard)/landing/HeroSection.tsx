        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 items-center">
          ...
          <div className="space-y-12 max-w-xl">
            ...
            <div className="space-y-6">
              <h1 className="text-5xl md:text-7xl font-extrabold text-slate-900 dark:text-neutral-100 tracking-tight leading-[1.05]">
              ...
              <p className="text-slate-700 dark:text-neutral-400 text-lg md:text-xl leading-relaxed max-w-md font-medium">

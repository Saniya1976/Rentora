...
const DiscoverSection = () => {
  return (
    <motion.section
      ...
      className="py-24 bg-white dark:bg-neutral-900 transition-colors duration-300"
    >
